...
wszst create build/Event --dest out/Event_F.szs
...
wszst create build/Event --dest out/Event_I.szs
...
copy out\Event_F.szs out\MenuOther_F.szs
copy out\Event_G.szs out\MenuOther_G.szs
copy out\Event_I.szs out\MenuOther_I.szs
copy out\Event_J.szs out\MenuOther_J.szs
copy out\Event_K.szs out\MenuOther_K.szs
copy out\Event_M.szs out\MenuOther_M.szs
copy out\Event_Q.szs out\MenuOther_Q.szs
copy out\Event_S.szs out\MenuOther_S.szs
copy out\Event_U.szs out\MenuOther_U.szs

copy out\Event_E.szs out\Channel_E.szs
copy out\Event_F.szs out\Channel_F.szs
copy out\Event_G.szs out\Channel_G.szs
copy out\Event_I.szs out\Channel_I.szs
copy out\Event_J.szs out\Channel_J.szs
copy out\Event_K.szs out\Channel_K.szs
copy out\Event_M.szs out\Channel_M.szs
copy out\Event_Q.szs out\Channel_Q.szs
copy out\Event_S.szs out\Channel_S.szs
